...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks =   5524.375339480173; // y position of the parallel encoder (in tick units) // confusion
        public double perpXTicks =  -5386.0933054606085; // x position of the perpendicular encoder (in tick units)
    }
